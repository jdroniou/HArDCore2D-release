...
\item 
using \mbox{\hyperlink{classTestCaseNonLinearity_a3d8a5c89c517dd0d9c835b7441ee9b07}{nonlinearity\+\_\+function\+\_\+type}} = \mbox{\hyperlink{mmread_8m_a8c89f3c0aeca4c3cc23a632c39fe026d}{std\+::function}}$<$ double(double, std\+::string)$>$
\begin{DoxyCompactList}\small\item\em type for nonlinear function \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{classTestCaseNonLinearity_a490a6f0868a2edd9ecd6a88aaaca1ddb}{Test\+Case\+Non\+Linearity}} (const int i\+TCNL, const double m=1.\+0)
...
\index{TestCaseNonLinearity@{TestCaseNonLinearity}!nonlinearity\_function\_type@{nonlinearity\_function\_type}}
\index{nonlinearity\_function\_type@{nonlinearity\_function\_type}!TestCaseNonLinearity@{TestCaseNonLinearity}}
\doxysubsubsection{\texorpdfstring{nonlinearity\_function\_type}{nonlinearity\_function\_type}}
{\footnotesize\ttfamily using \mbox{\hyperlink{classTestCaseNonLinearity_a3d8a5c89c517dd0d9c835b7441ee9b07}{Test\+Case\+Non\+Linearity\+::nonlinearity\+\_\+function\+\_\+type}} =  \mbox{\hyperlink{mmread_8m_a8c89f3c0aeca4c3cc23a632c39fe026d}{std\+::function}}$<$double(double,std\+::string)$>$}
...
{\footnotesize\ttfamily Test\+Case\+Non\+Linearity\+::\+Test\+Case\+Non\+Linearity (\begin{DoxyParamCaption}\item[{const int}]{i\+TCNL,  }\item[{const double}]{m = {\ttfamily 1.0} }\end{DoxyParamCaption})}
...
{\em i\+TCNL} & The id of the test case \\
\hline
...
i\+TCR\mbox{[}0\mbox{]}=-\/1\+: $f(u)=0$

i\+TCR\mbox{[}0\mbox{]}=1\+: $f(u)=u$

i\+TCR\mbox{[}0\mbox{]}=2\+: $f(u)=|u|^{m-1}u = |u|^m sign(u)$

i\+TCR\mbox{[}0\mbox{]}=3\+: $f(u)=max(u,0)^2$

i\+TCR\mbox{[}0\mbox{]}=4\+: $f(u)=(u+th)^+-th + eps u$

i\+TCR\mbox{[}0\mbox{]}=5\+: $f(u)=u$ truncated at 0 and th

i\+TCR\mbox{[}0\mbox{]}=6\+: Classical Stefan $f(s)=s$ if $s<0$, $f(s)=0$ if $0\le s\le 1$, $f(s)=s-1$ if $s>1$.
\begin{DoxyParams}{Parameters}
...
\item 
Schemes/\+Test\+Case/\mbox{\hyperlink{TestCaseNonLinearity_8hpp}{Test\+Case\+Non\+Linearity.\+hpp}}\item 
Schemes/\+Test\+Case/\mbox{\hyperlink{TestCaseNonLinearity_8cpp}{Test\+Case\+Non\+Linearity.\+cpp}}\end{DoxyCompactItemize}
