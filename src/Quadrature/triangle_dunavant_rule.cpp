...
int dunavant_degree(int rule)
    ...
    //  Purpose:
    //
    //    DUNAVANT_DEGREE returns the degree of a Dunavant rule for the
    // triangle.
    //
    //  Licensing:
    //
...
int dunavant_order_num(int rule)
    ...
    //  Purpose:
    //
    //    DUNAVANT_ORDER_NUM returns the order of a Dunavant rule for the
    // triangle.
    //
    //  Licensing:
    //
    ...
    //    Input, int RULE, the index of the rule.
    //
    //    Output, int DUNAVANT_ORDER_NUM, the order (number of points) of the
    // rule.
    //
{
    int order;
...
int *dunavant_suborder(int rule, int suborder_num)
    ...
    //
    //    Output, int DUNAVANT_SUBORDER[SUBORDER_NUM], the suborders of the
    // rule.
    //
{
    int *suborder;
...
int dunavant_suborder_num(int rule)
    ...
    //  Purpose:
    //
    //    DUNAVANT_SUBORDER_NUM returns the number of suborders for a Dunavant
    // rule.
    //
    //  Licensing:
    //
    ...
    //    Input, int RULE, the index of the rule.
    //
    //    Output, int DUNAVANT_SUBORDER_NUM, the number of suborders of the
    // rule.
    //
{
    int suborder_num;
...
{
    int s;
    double suborder_xy_rule_01[3 * 1] = {0.333333333333333, 0.333333333333333,
                                         0.333333333333333};
    double suborder_w_rule_01[1] = {1.000000000000000};
...
{
    int s;
    double suborder_xy_rule_02[3 * 1] = {0.666666666666667, 0.166666666666667,
                                         0.166666666666667};
    double suborder_w_rule_02[1] = {0.333333333333333};
...
{
    int s;
    double suborder_xy_rule_03[3 * 2] = {0.333333333333333, 0.333333333333333,
                                         0.333333333333333, 0.600000000000000,
                                         0.200000000000000, 0.200000000000000};
    double suborder_w_rule_03[2] = {-0.562500000000000, 0.520833333333333};
...
{
    int s;
    double suborder_xy_rule_04[3 * 2] = {0.108103018168070, 0.445948490915965,
                                         0.445948490915965, 0.816847572980459,
                                         0.091576213509771, 0.091576213509771};
    double suborder_w_rule_04[2] = {0.223381589678011, 0.109951743655322};
    ...
    //
{
    ...
    double suborder_w_rule_05[3] = {0.225000000000000, 0.132394152788506,
                                    0.125939180544827};
    ...
    //
{
    ...
    double suborder_w_rule_06[3] = {0.116786275726379, 0.050844906370207,
                                    0.082851075618374};
    ...
    //
{
    ...
    double suborder_w_rule_07[4] = {-0.149570044467682, 0.175615257433208,
    ...
    //
{
    ...
    double suborder_w_rule_08[5] = {0.144315607677787, 0.095091634267285,
                                    0.103217370534718, 0.032458497623198,
                                    0.027230314174435};
    ...
    //
{
    ...
    double suborder_w_rule_09[6] = {0.097135796282799, 0.031334700227139,
                                    0.077827541004774, 0.079647738927210,
                                    0.025577675658698, 0.043283539377289};
    ...
    //
{
    ...
    double suborder_w_rule_10[6] = {0.090817990382754, 0.036725957756467,
                                    0.045321059435528, 0.072757916845420,
                                    0.028327242531057, 0.009421666963733};
    ...
    //
{
    ...
    double suborder_w_rule_11[7] = {0.000927006328961, 0.077149534914813,
                                    0.059322977380774, 0.036184540503418,
                                    0.013659731002678, 0.052337111962204,
                                    0.020707659639141};
    ...
    //
{
    ...
    double suborder_w_rule_12[8] = {0.025731066440455, 0.043692544538038,
                                    0.062858224217885, 0.034796112930709,
                                    0.006166261051559, 0.040371557766381,
    ...
    //
{
    ...
    double suborder_w_rule_13[10] = {0.052520923400802, 0.011280145209330,
                                     0.031423518362454, 0.047072502504194,
                                     0.047363586536355, 0.031167529045794,
                                     0.007975771465074, 0.036848402728732,
    ...
    //
{
    ...
    double suborder_w_rule_14[10] = {0.021883581369429, 0.032788353544125,
                                     0.051774104507292, 0.042162588736993,
                                     0.014433699669777, 0.004923403602400,
                                     0.024665753212564, 0.038571510787061,
    ...
    //
{
    ...
    for (i = 0; i < 2; i++) {
        for (j = 0; j < n; j++) {
            phy[i + j * 2] =
                t[i + 0 * 2] * (1.0 - ref[0 + j * 2] - ref[1 + j * 2]) +
                t[i + 1 * 2] * +ref[0 + j * 2] + t[i + 2 * 2] * +ref[1 + j * 2];
        }
    }
