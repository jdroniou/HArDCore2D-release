// Implementation of the Locally Enriched Polytopal Non-Conforming scheme in 2D for the diffusion model
//
...
/*!
* @defgroup LEPNC
* @brief Implementations of the Locally Enriched Polytopal Non-Conforming method
*/
...
/// @brief The LEPNC_diffusion class provides an implementation of the LEPNC method for the stationnary diffusion problem \f$-div(K\nabla u)=f\f$
